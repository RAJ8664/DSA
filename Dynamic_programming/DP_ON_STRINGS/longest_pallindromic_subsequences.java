...
public class longest_pallindromic_subsequences {
    public static void main(String[] args) {
        ...
        System.out.println(solve_memo(n - 1,n - 1, s, s2,dp));
        System.out.println(solve_tabu(n ,n, s, s2, dp));
    }

    //just find the longest common subsequences of given s and reverse of s;
